...
class CelestialBody {
public:
    CelestialBody::CelestialBody(char* bObj, char* bName, char* bdTexture, char* bsTexture, float bMass, float bRadius, float dayLengh, CelestialBody* orbitBody, float oRadius); // Constructor
